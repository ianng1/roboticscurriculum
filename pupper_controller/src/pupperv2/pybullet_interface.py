...
class Interface:
    ...
    def __init__(
        ...
        #self.maze_filename = os.path.join(
        #        data.get_data_path(), "pupper_test_maze.urdf")
    ...
    def activate(self):
        ...
        #self.maze_id = self._bullet_client.loadURDF(
        #    self.maze_filename, useFixedBase=False, basePosition=[0, 0, 0.25], baseOrientation=rotate_z(np.pi/2))
